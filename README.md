...
- [_SAST tools selection.md_](https://github.com/android-app-sast/VulsTotal/blob/master/SAST tools selection.md): Details for selecting the 11 selected tools.
...
- [Android_specific_CVEs_detail.md](https://github.com/android-app-sast/VulsTotal/blob/master/Android_specific_CVEs_detail.md): Describes the details of the types of vulnerabilities contained in Android-specific CVEs.
- [The unique vuln types within 11 tools.md](https://github.com/android-app-sast/VulsTotal/blob/master/The unique vuln types within 11 tools.md): Details of vulnerability types uniquely supported by 11 tools.
